...
public class FareCalculatorServiceTest {
    ...
    public void calculateFareCarWithLessThanHalfHourParkingTime(){
        Date inTime = new Date();
        inTime.setTime( System.currentTimeMillis() - (  29 * 60 * 1000) );//30 minutes parking time should give 0.0 parking fare
        Date outTime = new Date();
        ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.CAR,false);
    ...
    @Test
    public void calculateFareBikeWithEqualToHalfHourParkingTime(){
        Date inTime = new Date();
